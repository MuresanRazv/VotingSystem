...
from .vote import create_vote, get_votes_by_poll_id, get_votes_by_user_id, get_vote_by_id, delete_vote, delete_votes_by_poll_id, delete_votes_by_user_id, update_vote, get_vote_by_poll_and_user_id